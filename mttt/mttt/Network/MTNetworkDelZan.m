...
#import "MTNetworkDelZan.h"

@implementation MTNetworkDelZan
...
-(void)delZanByUserId:(NSNumber *)myId picId:(NSNumber *)picId rBlock:(MTNetworkUniversalBlock)block
{
    ...
    [session oPostWithSubURL:MTNetworkDelZanURL params:@{@"userId" : myId, @"pictureId" : picId} constructingBodyWithBlock:^(id<AFMultipartFormData> formData) {
        ;
