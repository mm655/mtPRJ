...
#define CONSTRAINT_CENTERING_H_OFFSET(VIEW, OFFSET) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeCenterX relatedBy: NSLayoutRelationEqual toItem: [VIEW superview] attribute: NSLayoutAttributeCenterX multiplier: 1.0f constant: OFFSET]

#define CONSTRAINT_CENTERING_V_OFFSET(VIEW, OFFSET) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeCenterY relatedBy: NSLayoutRelationEqual toItem: [VIEW superview] attribute: NSLayoutAttributeCenterY multiplier: 1.0f constant: OFFSET]
...
#define CONSTRAINT_ALIGNING_LEFT2CENTER(VIEW, INDENT) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeLeft relatedBy: NSLayoutRelationEqual toItem: [VIEW superview] attribute: NSLayoutAttributeCenterX multiplier: 1.0f constant: INDENT]
#define CONSTRAINT_ALIGNING_RIGHT2CENTER(VIEW, INDENT) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeRight relatedBy: NSLayoutRelationEqual toItem: [VIEW superview] attribute: NSLayoutAttributeCenterX multiplier: 1.0f constant: INDENT]
...
//add by jeason
#define CONSTRAINT_ALIGNING_PAIR_CENTERY_BOTTOM_TOP(VIEW1, VIEW2, OFFSET) [NSLayoutConstraint constraintWithItem: VIEW2 attribute: NSLayoutAttributeBottom relatedBy: NSLayoutRelationEqual toItem:VIEW1 attribute: NSLayoutAttributeTop multiplier: 1.0f constant: OFFSET]
...
#define CONSTRAINT_LEFT2RIGHT(VIEW1,VIEW2,OFFSET) [NSLayoutConstraint constraintWithItem: VIEW1 attribute: NSLayoutAttributeLeft relatedBy: NSLayoutRelationEqual toItem:VIEW2 attribute: NSLayoutAttributeRight multiplier:1.0f constant: OFFSET]

#define CONSTRAINT_RIGHT2LEFT(VIEW1,VIEW2,OFFSET) [NSLayoutConstraint constraintWithItem: VIEW1 attribute: NSLayoutAttributeRight relatedBy: NSLayoutRelationEqual toItem:VIEW2 attribute: NSLayoutAttributeLeft multiplier:1.0f constant: OFFSET]

#define CONSTRAINT_RIGHT2RIGHT(VIEW1,VIEW2,OFFSET) [NSLayoutConstraint constraintWithItem: VIEW1 attribute: NSLayoutAttributeRight relatedBy: NSLayoutRelationEqual toItem:VIEW2 attribute: NSLayoutAttributeRight multiplier:1.0f constant: OFFSET]

#define CONSTRAINT_LEFT2LEFT(VIEW1,VIEW2,OFFSET) [NSLayoutConstraint constraintWithItem: VIEW1 attribute: NSLayoutAttributeLeft relatedBy: NSLayoutRelationEqual toItem:VIEW2 attribute: NSLayoutAttributeLeft multiplier:1.0f constant: OFFSET]

#define CONSTRAINT_LEFT2CENTER(VIEW,OFFSET) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeLeft relatedBy: NSLayoutRelationEqual toItem:[VIEW superview] attribute: NSLayoutAttributeCenterX multiplier:1.0f constant: OFFSET]

#define CONSTRAINT_RIGHT2CENTER(VIEW,OFFSET) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeRight relatedBy: NSLayoutRelationEqual toItem:[VIEW superview] attribute: NSLayoutAttributeCenterX multiplier:1.0f constant: OFFSET]


#define CONSTRAINT_TOP2BOTTOM(VIEW1,VIEW2,OFFSET)  [NSLayoutConstraint constraintWithItem: VIEW1 attribute: NSLayoutAttributeTop relatedBy: NSLayoutRelationEqual toItem:VIEW2 attribute: NSLayoutAttributeBottom multiplier:1.0f constant: OFFSET]


#define CONSTRAINT_BOTTOM2TOP(VIEW1,VIEW2,OFFSET)  [NSLayoutConstraint constraintWithItem: VIEW1 attribute: NSLayoutAttributeBottom relatedBy: NSLayoutRelationEqual toItem:VIEW2 attribute: NSLayoutAttributeTop multiplier:1.0f constant: OFFSET]
...
#define MATCH_CENTERV_ALIGNMENT(FROMVIEW, TOVIEW, ALIGNMENT) INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Match Center", CONSTRAINT_ALIGNING_PAIR_CENTERY(FROMVIEW, TOVIEW, ALIGNMENT))
...
#define ALIGN_PAIR_RIGHT_ALIGNMENT(VIEW1, VIEW2, ALIGNMENT)      INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Align Pair", CONSTRAINT_ALIGNING_PAIR_RIGHT(VIEW1, VIEW2, ALIGNMENT))
...
#define ALIGN_PAIR_TOP_WITH_AIGHNMENT(VIEW1, VIEW2, ALIGNMENT)        INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Align Pair", CONSTRAINT_ALIGNING_PAIR_TOP(VIEW1, VIEW2, ALIGNMENT))
